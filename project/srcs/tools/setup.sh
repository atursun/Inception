...
# Geçici olarak local (socket) üstünden ayağa kaldırıp kullanıcı/grant'ları
# her açılışta idempotent şekilde garanti ediyoruz. Böylece volume eski kalsa bile
# WordPress'in bağlanması engellenmez.
